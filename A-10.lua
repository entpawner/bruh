---====== Zvardin if you're seeing this can i pkease get your A-10? ======---
...
local entity = Spawner.createEntity({
    CustomName = "A10",
    Model = "rbxassetid://12643242104", -- Your entity's model url here ("rbxassetid://1234567890" or GitHub raw url)
    Speed = 40,
    MoveDelay = 2,
    HeightOffset = 0,
    CanKill = true,
